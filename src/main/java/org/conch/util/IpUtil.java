...
public class IpUtil {
    ...
    static {
        // default coordinates
        DEFAULT_COORDINATES.put("180.149.130.27", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"39.9289\",\"Y\":\"116.3883\"}"));
        DEFAULT_COORDINATES.put("114.80.68.233", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"31.0456\",\"Y\":\"121.3997\"}"));
        DEFAULT_COORDINATES.put("223.104.96.113", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"28.1375\",\"Y\":\"106.8200\"}"));
        DEFAULT_COORDINATES.put("14.215.160.13", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"23.0268\",\"Y\":\"113.1315\"}"));
        DEFAULT_COORDINATES.put("123.151.77.71", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"39.1422\",\"Y\":\"117.1767\"}"));
        DEFAULT_COORDINATES.put("112.66.1.203", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"20.0458\",\"Y\":\"110.3417\"}"));
        DEFAULT_COORDINATES.put("113.116.52.10", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"22.5333\",\"Y\":\"114.1333\"}"));
        DEFAULT_COORDINATES.put("49.83.135.23", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"32.0617\",\"Y\":\"118.7778\"}"));
        DEFAULT_COORDINATES.put("36.149.20.90", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"39.9289\",\"Y\":\"116.3883\"}"));
        DEFAULT_COORDINATES.put("223.240.28.101", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"31.8639\",\"Y\":\"117.2808\"}"));
        DEFAULT_COORDINATES.put("23.251.52.66", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"22.3310\",\"Y\":\"114.1592\"}"));
        DEFAULT_COORDINATES.put("113.76.101.170", com.alibaba.fastjson.JSON.parseObject("{\"X\":\"22.2769\",\"Y\":\"113.5678\"}"));
    }
    ...
    private static Map<String,String> convertNatAddrToIP(Set<String> natAddrSet){
        ...
        if(wishToUpdateNatAddrSet.size() > 0){
            ...
            try {
                ...
                verifyResponse = RestfulHttpClient.getClient(UrlManager.getFoundationApiUrl("/sc/natServices/natAddrToIP"))
                        .post()
