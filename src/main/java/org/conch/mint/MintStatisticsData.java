...
public class MintStatisticsData {
     ...
     * @return
     */
    public static MintStatisticsData init(long generatorId, int timestamp,int height) {
        ...
        mintStatisticsData.setGenerateRate(new BigDecimal("1").divide(new BigDecimal(height + ""), BigDecimal.ROUND_HALF_UP, 6));
        mintStatisticsData.setHeight(height);
     ...
     * @param block
     */
    public void updateData(Block block, int height) {
        ...
        this.generateRate = new BigDecimal(generateCount).divide(new BigDecimal(height + ""), BigDecimal.ROUND_HALF_UP, 6);
