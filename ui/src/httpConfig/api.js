...
const MGR_URL = process.env.NODE_ENV === 'development' ? "http://127.0.0.1:8800/chain" : "http://47.57.235.8:8800/chain";
...
const POLYGON_URL = process.env.NODE_ENV === 'development' ? "https://mumbai.polygonscan.com" : "https://polygonscan.com";
