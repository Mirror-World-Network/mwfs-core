...
const en = {
    ...
    acrossChains:{
        ...
        'address_tip':"Please input the address on the target chain",
        ...
        'tip-2':"2. On the premise that the address of the target chain is correct, if it is necessary to transfer the assets across the chain from MW chain, please transfer the corresponding quantity to the lock in address ( ",
        'tip-3':"); when transferring the assets from ",
        'tip-4':"chain to MW chain, please transfer the corresponding quantity to the lock on the ",
