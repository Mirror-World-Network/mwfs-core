...
const en = {
    login: {
        ...
        'login_tip3': "To avoid the mnemonic phrase being maliciously stolen, please use the local node or your trust node for large amount transfer!",
        'login_tip4': "CDW-87L3-HT5W-K9WD-3AQJ3 is a public experience account, please do not transfer money or apply for rewards to this account!",
        'language': 'Language',
        'login': 'Login',
