...
const en = {
    ...
    acrossChains: {
        ...
        'Polygon_target_address': "Polygon address",
        'Polygon_address_tip': "Please input the address on the Polygon chain",
        'Polygon_target_balance': "Polygon amount redeemed",
        'Polygon_convertible_balance': "Polygon convertible quota today",
        'Polygon_rate': "Polygon rate",
        'Polygon_mw_exchange_title': "MW(Polygon) Exchange",
        'tipChian6': "Make sure the binding Polygon address is:",
        'bindAddress_success_Polygon': "Polygon address bound successfully",
        'bindAddress_fail_Polygon': "Polygon address bound failed",
        'no_BMWExchangeAddress': "The acceptance address is Polygon exchange address, please transfer through the Asset Exchange page",
        'no_PolygonAddress': "Please bind the Polygon address first! ! !",

        'inBlackList': "account in blackList！！！",
        ...
        'tip-4': "3. Please do not transfer other assets to the exchange address. If any loss is caused, you should bear it by yourself;",
        'tip-5': "4. Contract Address is",
        'sure': "sure",
        'cancel': "cancel",
    ...
    transaction: {
        ...
        'transaction_type_mw_to_polygon':"polygon",
        'self': "You",
