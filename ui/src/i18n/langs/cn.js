...
const cn = {
    ...
    hubsetting: {
        ...
        'set_password': "设置矿工管理密码",
        'confirm_password': "确认矿工管理密码",
    ...
    header: {
        ...
        'forging_error_no_admin_password': "无法确定挖矿状态，请先设置矿工管理密码",
    ...
    notification: {
        ...
        'hubsetting_inconsistent_password': "两次输入的矿工管理密码不一致！",
    ...
    rules: {
        ...
        onlyInteger: '只能输入整数',
        plz_input_admin_pwd: '请输入矿工管理密码',
        plz_input_address_admin_pwd: '请输入节点地址和矿工管理密码',
        plz_input_admin_pwd_again: '请再次输入矿工管理密码',
        'plz_input_sharder_pwd': '请输入MW官网登录密码',
        'plz_input_sharder_pwd_again': '请再次输入MW官网登录密码',
        inconsistent_admin_password: "两次输入的矿工管理密码不一致！",
