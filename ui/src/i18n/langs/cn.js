...
const cn = {
    ...
    acrossChains: {
        ...
        'Polygon_target_address': "Polygon地址",
        'Polygon_address_tip': "请输入Polygon地址",
        'Polygon_target_balance': "MW(Polygon)已兑换数额",
        'Polygon_convertible_balance': "Polygon今日可兑换额度",
        'Polygon_rate': "MW(Polygon)兑换比例",
        'Polygon_mw_exchange_title': "MW(Polygon)兑换",
        'tipChian6': "绑定Polygon地址为:",
        'bindAddress_success_Polygon': "Polygon地址绑定成功",
        'bindAddress_fail_Polygon': "Polygon地址绑定失败",
        'no_PolygonExchangeAddress': "接受地址为Polygon兑换地址,请通过资产兑换页面进行转账",
        'no_PolygonAddress': "请先绑定Polygon地址！！！",

        'inBlackList': "账户在黑名单列表中！！！",
        'more': "敬请期待更多资产链！！！",
        'tip-0': "温馨提示：",
        'tip-1': "1.如果你需要进行资产转移，请先绑定好您的目标链地址，如未绑定产生损失，自行承担;",
        'tip-2': "2.在确定目标链地址正确的前提下，如需要从mw链将资产进行跨链转移，请向兑换地址（",
        'tip-3': "）转帐对应数量;",
        'tip-4': "3.请勿向兑换地址中转入其他资产，如造成损失，自行承担;", 
        'tip-5': "4.合约地址:",
        'sure': "确定",
        'cancel': "取消",
